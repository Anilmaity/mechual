...
//         stepper.moveTo(calState.centerPosition);
//       } else {
//         stepper.moveTo(LARGE_DISTANCE); // Move CCW to find left limit
//       }
//     } else {
//       stepper.moveTo(-LARGE_DISTANCE); // Move CW to find right limit
//     }
//     stepper.run(); // Execute motion with acceleration
//   } else if (calState.phase == 2) { // Move CCW to left limit
//     if (isLeftLimitTriggered()) {
//       stepper.stop();
//       calState.leftPosition = stepper.currentPosition();

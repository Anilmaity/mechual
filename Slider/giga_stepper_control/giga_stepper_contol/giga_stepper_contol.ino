...
// Pin definitions
const uint8_t EN_PIN = 42;                // Enable pin
const uint8_t DIR_PIN = 46;               // Direction pin
const uint8_t STEP_PIN = 44;              // Step pin
...
void configureStepper() {
    ...
    stepper.setMinPulseWidth(10);  // Set minimum pulse width to 4 µs for DM542
